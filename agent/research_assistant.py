...
Your goal is to create interesting and specific insights related to the topic.
...
- Aim for approximately {section_max_words} words maximum
...
2. They wrote their findings into a memo.
...
Target around {intro_conclusion_target_words} words, crisply previewing (for introduction) or recapping (for conclusion) all of the sections of the report.
